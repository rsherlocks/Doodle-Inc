...
import com.example.androidshaper.doodleinctestapplication.activity.CategoryViewActivity;
...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.MyViewHolder>
{
            ...
            int position)
    {
        ...
        sharedPreferences= CategoryViewActivity.sharedPreferences;
        ...
        if (sharedPreferences.contains("category"))
        {
            ...
            holder.checkBoxCategory.setChecked(false);
            for (CategoryName categoryName : new ArrayList<>(categoryNameList))
            {
                String nameCheck=categoryName.getCategoryName().trim();
        ...
        holder.checkBoxCategory.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                if (holder.checkBoxCategory.isChecked())
                {
